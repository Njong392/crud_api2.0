...
RUN echo "pdo_mysql.default_socket=" > /usr/local/etc/php/conf.d/disable-mysql-socket.ini
...
# # Now, we give permissions to the non-priviledged user to have acces to the /var/www
# RUN chown -R www-data:www-data /var/www

# # Set permissions for the composer.json and composer.lock
# RUN chmod -R 775 /var/www/html/composer.json /var/www/html/composer.lock
